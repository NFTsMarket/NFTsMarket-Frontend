...
function ShowProduct(props) {
    ...
    const product = 
      {
        ...
        price: 30.50,
        categories: "Monkeys",
        picture: "https://i.natgeofe.com/n/82fddbcc-4cbb-4373-bf72-dbc30068be60/drill-monkey-01.jpg",
        updatedAt: Date(),
        createdAt: Date()
      }
 ...
 <SimpleGrid columns={3}>
    <Product product={product}  displayButton={false}/>
      ...
      <Text 
      center py={5} width={700} 
      style={{display:'block', verticalAlign: 'middle', marginTop: "25%"}} 
      > 
